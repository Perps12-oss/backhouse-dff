...
- `dev/scripts/smoke_virtual_grid.py`
- `dev/scripts/smoke_thumb_grid.py`

**Regression harness:** `dev/tests/test_post_v1_audit_verification.py` (Phase 8
aggregate) invokes `smoke_virtual_grid` / `smoke_thumb_grid` via
`dev/scripts/post_v1_audit_verify.py`.
